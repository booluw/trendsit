            ...
            <nuxt-link :to="{ path: '/',hash:'#wifi'}" class="service-card box-border px-2 py-4 md:px-14 md:py-14 bg-gray-700 flex flex-col items-center justify-center hover:bg-gray-600 cursor-pointer">              
              ...
              <g>
                <path d="M54.615,19.123c-7.243-7.244-16.89-11.233-27.161-11.233S7.537,11.878,0.293,19.123c-0.391,0.391-0.391,1.023,0,1.414
                  ...
                  s0.512-0.098,0.707-0.293C55.006,20.146,55.006,19.513,54.615,19.123z" fill="#db2777"/>
                ...
                <path d="M27.454,24.508c-5.825,0-11.295,2.263-15.404,6.371c-0.391,0.391-0.391,1.023,0,1.414s1.023,0.391,1.414,0
                  ...
                  s0.512-0.098,0.707-0.293c0.391-0.391,0.391-1.023,0-1.414C38.75,26.771,33.279,24.508,27.454,24.508z" fill="#db2777"/>
